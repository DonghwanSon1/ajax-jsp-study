...
<body>
	...
	<p>
		...
		<!--
			필드값에 직접접근한걸까??
			teacher에 접근했을 때 벨류값을 Person타입 객체이다.
			해당 Person객체에 각 필드에 담긴 값을 출력하고자 한다면 키값.필드명으로 접근하면됌
			내부적으로 getter메서드를 찾아서 호출이 되서 값을 가져오는 구조 
			=> 항상 명심해야할 사항 : getter메서드를 항상 만들어줘야함
		-->
	</p>	
	<hr>
	...
	표현식으로 없는 키값을 제시했을 경우 : &lt;= aaa &gt; <br> <!-- 500 에러 발생 -->
	...
	requestScope, sessionScope, applicationScope에 있는 "scope" 키값에 해당하는 밸류도 뽑고 싶다. <br>
