...
<body>
	...
	<p>
		* EL연산 <br>
		...
		1One이 텅 비어있습니까? : ${ empty lOne } <br>
		1Two가 텅 비어있습니까? : ${ empty lTwo } <br>
	</p>
	...
	<p>
		* EL연산에서 배운 키워드만 가지고 써볼것 <br>
		big이 small 보다 크고 lOne이 텅 비어있습니까? : ${big > small && empty lOne } <br>
		big과 small의 곱은 4의 배수 입니까? :  ${ (big * small) / 4 == 0  }<br>
		lTwo가 텅 비어있지 않거나 또는 sOne에 담긴 값이 "안녕하세요" 와 일치합니까? : ${ !empty lTwo || sOne == "안녕하세요" } <br>
	</p>
