	...
	<!-- 
		* JSP를 이루는 구성 인자
		1. JSP 스크립팅원소 : JSP페이지에서 자바코드를 직접 기술할 수 있게 하는 기술
			예) 스크립틀릿, 표션식, 선언문
		2. 지시어 : JSP페이지 정보에 대한 내용을 표현한다거나 (page 지시어)
			또 다른 페이지를 포함할때 사용 (include 지시어)
			예) page지시어, include지시어, taglib지시어(라이브러리 추가 시 사용)
		3. JSP 액션 태그 : XML 기술을 이용해서 기존의  jsp문법을 확장하는 기술을 제공하는 태그
		...
		- 커스텀 액션 태그(Custom Action Tag)
			...
			=> 모든 태그명 앞에 jsp:이외의 다른 접두어 붙음. (종류는 다양)
