...
public class JqAjaxController3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		jObj.put("gender", m.getGender()); // {memberNo : 1, memberName : "홍길동", age : 50, gender : "s남성"} 
		...
		*/
		...
		// VO 객체 하나만 응답 시 JSONObject{} 형태로 만들어져서 응답
		
		// ArrayList<Member>
		ArrayList<Member> list = new ArrayList();
		list.add(new Member(1, "김길동", 40, "남성"));
		list.add(new Member(2, "홍길동", 30, "여성"));
		list.add(new Member(3, "이길동", 34, "남성"));
		...
		// ArrayList 응답 시 JSONArray[] 형태로 만들어짐
